...
enum AuthntcationInteractor: URLRequestBuilder {
    ...
    case Register(fname : String ,lname:String,email:String,phone:String,password:String,device_id:String,device_type:String,acc_type:String , address : String , car_type : String)
    ...
    internal var parameters: Parameters? {
        ...
        case .Register(fname : let fname , lname: let lname , email: let email, phone: let phone, password: let password, device_id: let device_id, device_type: let device_type, acc_type: let acc_type , address : let address , car_type : let car_type  ):
            params["fname"] = fname
            params["lname"] = lname
            params["email"] = email
            params["phone"] = phone
