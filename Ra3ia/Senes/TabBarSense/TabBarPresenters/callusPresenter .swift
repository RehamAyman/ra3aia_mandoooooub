    ...
    func getSocialData(){
        ...
        TabBarinteractor.social.send(SocialModel.self){
            ...
            case .success(let value):
                ...
                self.view?.setPhoneNum(phone: value.data.phone)
                self.view?.setEmail(email: value.data.email)
                self.view?.setWhatssapp(whatsNumber: value.data.whatsapp)
